...
class MedicalAgentService(BaseAgent):
    ...
    def _build_workflow(self):
        ...
        health_analyst = HealthAnalystNodes(self.llm)
        ...
        graph.add_node("health_analyst", health_analyst.node_health_analyst)
        graph.add_node("emergency_advice", health_analyst.node_emergency_advice)
